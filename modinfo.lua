...
meta =
{
    ...
    description = "Adds a new Bank station type. This station allows for the users to deposit money, which earns interest but cannot be used until it is withdrawn. Deposited money earns 2% compounding interest every 5 minutes.\n\nThe Station Costs 1 million credits to found, and can hold a maximum of 1 million credits in its account. The bank can be upgraded to increase its maximum account balance. If the account is full, interest payments are added directly to the owning Factions credits.\n\nLevel 1 (Base Level): Cost 1 Million credits | Max balance 1 Million credits\nLevel 2: Cost 10 Million credits | Max balance 11 Million credits\nLevel 3: Cost 25 Million credits | Max balance 36 Million credits\nLevel 4: Cost 40 Million credits | Max balance 76 Million credits\nLevel 5: Cost 100 Million credits | Max balance 176 Million credits\nLevel 6: Cost 200 Million credits | Max balance 376 Million credits",
